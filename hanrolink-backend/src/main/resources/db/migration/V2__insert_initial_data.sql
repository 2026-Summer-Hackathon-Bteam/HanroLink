INSERT INTO regions (name, sort_order, created_at, updated_at)
VALUES
  ('北海道', 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('東北', 20, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('関東', 30, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('中部', 40, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('近畿', 50, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('中国', 60, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('四国', 70, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  ('九州', 80, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
